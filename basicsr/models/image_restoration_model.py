...
class ImageRestorationModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        print(total_num)
        macs, params = get_model_complexity_info(self.net_g, (6, 180, 320), as_strings=True, print_per_layer_stat=True)
        print(macs)
    ...
    def dist_validation(self, dataloader, current_iter, tb_logger, save_img, rgb2bgr, use_image):
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            B,C,H,W = visuals['result'].shape
            visuals['gt'] = visuals['gt'][:,:,:H,:W]
    ...
    def check_image_size(self, x):
        _, _, h, w = x.size()
        mod_pad_h = (self.patch - h % self.patch) % self.patch
        mod_pad_w = (self.patch - w % self.patch) % self.patch
